...
- Review Phase 6 super admin portal foundation branch.
...
- Current phase visual status: Phase 6 READY_FOR_REVIEW and marked as the active phase in the roadmap.

## Current blockers

- None known.
- Phase 7 must not begin until the user explicitly starts it.
...
- Backend, tenant/database, AI provider, RAG, chat API, widget-key, static widget, business portal, and super admin portal foundations exist; no notification workflow, production deployment, or CI exists yet.
- Keep future-scope features out of MVP.
- Keep Phase 7 notification workflow work out of Phase 6 review changes.
...
- `10_decisions_log.md` when Phase 7 lead workflow/email provider decisions are made.

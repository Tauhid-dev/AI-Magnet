...
flowchart TB
    ...
    PR01["PR-01<br/>Production Authentication<br/>critical blocker"]
    PR02["PR-02<br/>Abuse Protection and Widget Origins<br/>critical blocker"]
    PR03["PR-03<br/>Tenant Isolation and Privacy<br/>high blocker"]
    PR04["PR-04<br/>Production Infra, TLS, Backups<br/>critical blocker"]
    ...
    class PR00 verified
    class PR01,PR02,PR03,PR04,PR05 blocker
